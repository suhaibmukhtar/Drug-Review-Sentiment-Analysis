...
ROOT_PACKAGE = Path(os.path.abspath(os.path.dirname(__file__)))
sys.path.append(str(ROOT_PACKAGE))
...
setup(
    ...
    install_requires=get_requirements(os.path.join(ROOT_PACKAGE,'requirements.txt'))
)